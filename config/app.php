...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    /
    / Enter your analytic and metric key in ".env"
    / If have key - code is enabled, else disabled
    /
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Do not change the locale keys!!!
    | They are used in the database of materials
    |
    */
